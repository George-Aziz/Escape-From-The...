...
int main()
{
    ...
    Shader ourShader("shader_textureTut.vs", "shader_textureTut.fs");
   ...
   unsigned int indices[] = {  
    ...
    unsigned char *data = stbi_load("image0.jpg", &width, &height, &nrChannels, 0);
    if (data)
    {
    ...
    glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, GL_LINEAR);
    // load image, create texture and generate mipmaps
    data = stbi_load("image0.jpg", &width, &height, &nrChannels, 0);
    if (data)
    {
